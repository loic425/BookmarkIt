...
Before we dive separately into every BookmarkIt concept, you need to have an overview of how our main application is structured.
...
**BookmarkIt** is based on Symfony, which is a leading PHP framework to create web applications. Using Symfony allows
...
BookmarkIt uses a lot of libraries for various tasks:
