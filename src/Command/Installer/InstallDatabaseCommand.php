...
class InstallDatabaseCommand extends AbstractInstallCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Install BookmarkIt database.')
            ->setHelp(<<<EOT
The <info>%command.name%</info> command creates BookmarkIt database.
EOT
            )
        ;
    }
    ...
    {
        $output->writeln(sprintf('Creating BookmarkIt database for environment <info>%s</info>.', $this->getEnvironment()));
